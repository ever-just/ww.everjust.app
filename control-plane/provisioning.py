...
EVERJUST_MODULES = "base,everjust_brand,everjust_theme,everjust_home,voip_oca,everjust_sms_gateway,document_page,document_page_partner,document_url,attachment_zipped_download"
